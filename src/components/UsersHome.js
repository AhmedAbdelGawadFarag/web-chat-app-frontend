...
class UserHome extends React.Component {
    ...
    showChat(messages, friend_id) {//show chat with that messages
        this.cnt += 1;
        let current = <ChatBox key={this.cnt} messages={messages} friend_id={friend_id} ></ChatBox>
    ...
    render() {
        return (
            ...
            <div className="user-home">
                <ActionCableProvider url={"ws:" + Rails.defaults.baseURL.substr(5, Rails.defaults.baseURL.length) + '/cable'}>
                    <div>
